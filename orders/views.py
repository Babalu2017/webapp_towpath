...
from .models import Payment, OrderedItem
...
def place_order(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            order.tax_data = simplejson.dumps(tax_data)
...
def payments(request):
    ...
    if request.headers.get('x-requested-with') == 'XMLHttpRequest' and request.method == 'POST':
        ...
        # MOVE THE CART ITEMS TO ORDERED ITEM MODEL
        ...
        for item in cart_items:
            ...
            ordered_item.productitem = item.productitem
            ordered_item.quantity = item.quantity
            ordered_item.price = item.productitem.price
            ordered_item.amount = item.productitem.price * item.quantity # total amount
            ordered_item.save()
        ...
        for i in cart_items:
            if i.productitem.vendor.user.email not in to_emails:
                ...
                ordered_item_to_vendor = OrderedItem.objects.filter(order=order, productitem__vendor=i.productitem.vendor)
                print(ordered_item_to_vendor)
