# Generated by Django 4.1.1 on 2022-11-10 15:45
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('my_shop', '0004_alter_category_category_name'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('productitem', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='my_shop.productitem')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.AddField(
