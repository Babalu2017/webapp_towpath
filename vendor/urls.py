...
urlpatterns = [
    ...
    path('myshop-builder/', views.myshop_builder, name='myshop_builder'),
    path('myshop-builder/category/<int:pk>', views.myshopitems_by_category, name='myshopitems_by_category'),
